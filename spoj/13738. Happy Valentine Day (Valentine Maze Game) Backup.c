...
void cal2(int f,int g,int side)
{
    ...
    if(inp[f][g+1]!='#' && g+1<n)
    {
        if(inp[f][g+1]=='C')
        {
            ...
            {
                cal4(f,g+1,2);
                if(bak>0)   sub[f][g]=bak;  cal1(f,g+1,2);
                if(bak>0)   sub[f][g]=bak;  cal2(f,g+1,2);
                if(bak>0)   sub[f][g]=bak;  cal3(f,g+1,2);
            }
            else
            {
                if(side==0)
...
void cal3(int f,int g,int side)
{
    ...
    if(inp[f][g-1]!='#' && g-1>=0)
    {
        if(inp[f][g-1]=='C')
        {
            ...
            {
                cal3(f,g-1,3);
                if(bak>0)   sub[f][g]=bak;  cal4(f,g-1,3);
                if(bak>0)   sub[f][g]=bak;  cal1(f,g-1,3);
                if(bak>0)   sub[f][g]=bak;  cal2(f,g-1,3);
            }
            else
            {
                if(side==0)
                ...
                else if(side==4)
                {
                    cal4(f,g-1,3);
                    if(bak>0)   sub[f][g]=bak;  cal1(f,g-1,3);
                    if(bak>0)   sub[f][g]=bak;  cal3(f,g-1,3);
                }
            }
        }
        else if(inp[f][g-1]=='W')
...
void cal4(int f,int g,int side )
{
    ...
    if(inp[f-1][g]!='#' && f-1>=0)
    {
        if(inp[f-1][g]=='C')
        {
            ...
            {
                cal4(f-1,g,4);
                if(bak>0)   sub[f][g]=bak;   cal1(f-1,g,4);
                if(bak>0)   sub[f][g]=bak;  cal2(f-1,g,4);
                if(bak>0)   sub[f][g]=bak;  cal3(f-1,g,4);
            }
            else
            {
                if(side==0)
                ...
                else if(side==4)
                {
                    cal2(f-1,g,4);
                    if(bak>0)   sub[f][g]=bak;  cal3(f-1,g,4);
                    if(bak>0)   sub[f][g]=bak;  cal4(f-1,g,4);
                }
            }
        }
        else if(inp[f-1][g]=='W')
